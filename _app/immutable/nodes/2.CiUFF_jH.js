import{s as x,a as h,e as f,h as C,d as l,c as d,b as u,i as g,j as v,k as c,n as b}from"../chunks/scheduler.BhmD_UjX.js";import{S as w,i as y,c as I,a as T,m as _,t as P,b as $,d as W}from"../chunks/index.2L2FXbiv.js";import{b as k}from"../chunks/paths.LWNTHENU.js";import{C as A}from"../chunks/Content.CyWzGPHe.js";function E(p){let e,s=`<div class="card bg-green-100 shadow-xl mb-8"><div class="card-body"><h2 class="card-title svelte-c5nfw9"><span class="badge badge-lg bg-green-400">NEW</span>
					Registration is open</h2> <div class="flex flex-row items-center gap-2 text-justify">The registration for ITACPC 2024 is now open!

					<span><a class="btn btn-primary" href="https://teams24.itacpc.it/">Register here</a></span></div></div></div> <h2 class="text-2xl sm:divider svelte-c5nfw9">About ITACPC</h2> <div class="flex flex-col gap-2 text-justify"><p>The ITACPC is a <strong>team-based programming
				...
				<a href="${k}/competition/sample-problem" class="btn-link link-secondary">click here to see a sample problem</a></p> <p>The competition contains typically around 10 problems, with
				...
				best of the University</strong> and thus deserve to go to SWERC.</p></div>`;return{c(){e=f("div"),e.innerHTML=s,this.h()},l(a){e=u(a,"DIV",{class:!0,"data-svelte-h":!0}),g(e)!=="svelte-1starca"&&(e.innerHTML=s),this.h()},h(){v(e,"class","w-full max-w-4xl text-lg flex flex-col px-2")},m(a,n){c(a,e,n)},p:b,d(a){a&&l(e)}}}function R(p){let e,s,a='<div class="max-w-3xl p-3"><div class="hero w-full h-20 xs:h-36 sm:h-48 md:h-64 lg:h-80 flex justify-start svelte-c5nfw9"><h1 class="font-mono text-xs xs:text-xl sm:text-2xl md:text-4xl lg:text-5xl mt-9 ml-1 xs:mt-14 xs:ml-3 sm:mt-16 sm:ml-4 md:mt-20 md:ml-5 lg:mt-24">italian<br/>collegiate<br/>programming<br/>contest</h1></div></div>',n,i,r;return i=new A({props:{$$slots:{default:[E]},$$scope:{ctx:p}}}),{c(){e=h(),s=f("div"),s.innerHTML=a,n=h(),I(i.$$.fragment),this.h()},l(t){C("svelte-p45pw5",document.head).forEach(l),e=d(t),s=u(t,"DIV",{class:!0,"data-svelte-h":!0}),g(s)!=="svelte-u0esr3"&&(s.innerHTML=a),n=d(t),T(i.$$.fragment,t),this.h()},h(){document.title="ITACPC - Italian Collegiate Programming Contest",v(s,"class","w-full flex justify-center bg-base-200 border-b-[1.5px] border-base-300 shadow-sm z-10")},m(t,o){c(t,e,o),c(t,s,o),c(t,n,o),_(i,t,o),r=!0},p(t,[o]){const m={};o&1&&(m.$$scope={dirty:o,ctx:t}),i.$set(m)},i(t){r||(P(i.$$.fragment,t),r=!0)},o(t){$(i.$$.fragment,t),r=!1},d(t){t&&(l(e),l(s),l(n)),W(i,t)}}}class M extends w{constructor(e){super(),y(this,e,null,R,x,{})}}export{M as component};

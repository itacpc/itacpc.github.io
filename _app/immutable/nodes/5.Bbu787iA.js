import{s as v,a as d,h as w,d as l,c as f,k as c,t as C,g as y,e as x,b as T,i as P,j as I,n as q}from"../chunks/scheduler.BhmD_UjX.js";import{S as k,i as R,c as p,a as h,m as g,t as $,b,d as _}from"../chunks/index.2L2FXbiv.js";import"../chunks/paths.BPykEI0a.js";import{H as A}from"../chunks/Hero.DEe2fJIa.js";import{C as L}from"../chunks/Content.CyWzGPHe.js";function H(o){let e;return{c(){e=C("ITACPC Rules")},l(a){e=y(a,"ITACPC Rules")},m(a,s){c(a,e,s)},d(a){a&&l(e)}}}function M(o){let e,a=`<p>The rules of ITACPC are inspired by the <a href="https://icpc.global/regionals/rules" class="btn-link link-secondary" target="_blank">ICPC regional contest rules</a>
			with some changes and additions since it&#39;s an online contest.</p> <p>Rules as of 15/11/2022:</p> <ul class="list-disc"><li>You can participate either individually or as part of a team.
				...
				a URL is fine. It&#39;s not allowed to re-use full solutions.</li></ul>`;return{c(){e=x("div"),e.innerHTML=a,this.h()},l(s){e=T(s,"DIV",{class:!0,"data-svelte-h":!0}),P(e)!=="svelte-1qjtqnq"&&(e.innerHTML=a),this.h()},h(){I(e,"class","w-full max-w-4xl 2xl:max-w-7xl flex flex-col gap-8")},m(s,n){c(s,e,n)},p:q,d(s){s&&l(e)}}}function E(o){let e,a,s,n,r;return a=new A({props:{$$slots:{default:[H]},$$scope:{ctx:o}}}),n=new L({props:{$$slots:{default:[M]},$$scope:{ctx:o}}}),{c(){e=d(),p(a.$$.fragment),s=d(),p(n.$$.fragment),this.h()},l(t){w("svelte-1adw3hk",document.head).forEach(l),e=f(t),h(a.$$.fragment,t),s=f(t),h(n.$$.fragment,t),this.h()},h(){document.title="Rules - ITACPC"},m(t,i){c(t,e,i),g(a,t,i),c(t,s,i),g(n,t,i),r=!0},p(t,[i]){const m={};i&2&&(m.$$scope={dirty:i,ctx:t}),a.$set(m);const u={};i&2&&(u.$$scope={dirty:i,ctx:t}),n.$set(u)},i(t){r||($(a.$$.fragment,t),$(n.$$.fragment,t),r=!0)},o(t){b(a.$$.fragment,t),b(n.$$.fragment,t),r=!1},d(t){t&&(l(e),l(s)),_(a,t),_(n,t)}}}function S(o,e,a){let{data:s}=e;return o.$$set=n=>{"data"in n&&a(0,s=n.data)},[s]}class V extends k{constructor(e){super(),R(this,e,S,E,v,{data:0})}}export{V as component};

import{s as v,a as h,e as f,h as C,d as l,c as d,b as u,i as g,j as x,k as c,n as w}from"../chunks/scheduler.jOzty4Yz.js";import{S as b,i as y,c as I,a as _,m as T,t as P,b as $,d as k}from"../chunks/index.Ddz2pc-A.js";import{b as S}from"../chunks/paths.CtiSbtzW.js";import{C as W}from"../chunks/Content.BgrFaKcB.js";function A(m){let e,s=`<h2 class="text-2xl sm:divider svelte-c5nfw9">About ITACPC</h2> <div class="flex flex-col gap-2 text-justify"><p>The ITACPC is a <strong>team-based programming
				...
				best of the University</strong> and thus deserve to go to SWERC.</p></div>`;return{c(){e=f("div"),e.innerHTML=s,this.h()},l(o){e=u(o,"DIV",{class:!0,"data-svelte-h":!0}),g(e)!=="svelte-14bffkf"&&(e.innerHTML=s),this.h()},h(){x(e,"class","w-full max-w-4xl text-lg flex flex-col px-2")},m(o,n){c(o,e,n)},p:w,d(o){o&&l(e)}}}function E(m){let e,s,o='<div class="max-w-3xl p-3"><div class="hero w-full h-20 xs:h-36 sm:h-48 md:h-64 lg:h-80 flex justify-start svelte-c5nfw9"><h1 class="font-mono text-xs xs:text-xl sm:text-2xl md:text-4xl lg:text-5xl mt-9 ml-1 xs:mt-14 xs:ml-3 sm:mt-16 sm:ml-4 md:mt-20 md:ml-5 lg:mt-24">italian<br/>collegiate<br/>programming<br/>contest</h1></div></div>',n,i,r;return i=new W({props:{$$slots:{default:[A]},$$scope:{ctx:m}}}),{c(){e=h(),s=f("div"),s.innerHTML=o,n=h(),I(i.$$.fragment),this.h()},l(t){C("svelte-p45pw5",document.head).forEach(l),e=d(t),s=u(t,"DIV",{class:!0,"data-svelte-h":!0}),g(s)!=="svelte-u0esr3"&&(s.innerHTML=o),n=d(t),_(i.$$.fragment,t),this.h()},h(){document.title="ITACPC - Italian Collegiate Programming Contest",x(s,"class","w-full flex justify-center bg-base-200 border-b-[1.5px] border-base-300 shadow-sm z-10")},m(t,a){c(t,e,a),c(t,s,a),c(t,n,a),T(i,t,a),r=!0},p(t,[a]){const p={};a&1&&(p.$$scope={dirty:a,ctx:t}),i.$set(p)},i(t){r||(P(i.$$.fragment,t),r=!0)},o(t){$(i.$$.fragment,t),r=!1},d(t){t&&(l(e),l(s),l(n)),k(i,t)}}}class M extends b{constructor(e){super(),y(this,e,null,E,v,{})}}export{M as component};

import{s as x,a as h,e as f,h as b,d as l,c as d,b as u,i as g,j as v,k as c,n as w}from"../chunks/scheduler.jOzty4Yz.js";import{S as C,i as y,c as I,a as T,m as _,t as P,b as $,d as E}from"../chunks/index.Ddz2pc-A.js";import{b as W}from"../chunks/paths.CaRpRzdZ.js";import{C as k}from"../chunks/Content.BgrFaKcB.js";function A(m){let e,s=`<div class="card bg-green-100 shadow-xl mb-8"><div class="card-body"><h2 class="card-title svelte-c5nfw9"><span class="badge badge-lg bg-green-400">NEW</span>
					Problem analysis livestream</h2> <div class="flex flex-row items-center gap-2 text-justify">The livestream for ITACPC 2025 is now available!

					<span><a class="btn btn-primary" href="https://www.youtube.com/live/qEZeY6D-y1E">Watch on YouTube</a></span></div></div></div> <h2 class="text-2xl sm:divider svelte-c5nfw9">About ITACPC</h2> <div class="flex flex-col gap-2 text-justify"><p>The ITACPC is a <strong>team-based programming
				...
				<a href="${W}/competition/sample-problem" class="btn-link link-secondary">click here to see a sample problem</a></p> <p>The competition contains typically around 10 problems, with
				...
				best of the University</strong> and thus deserve to go to SWERC.</p></div>`;return{c(){e=f("div"),e.innerHTML=s,this.h()},l(a){e=u(a,"DIV",{class:!0,"data-svelte-h":!0}),g(e)!=="svelte-a6u8w3"&&(e.innerHTML=s),this.h()},h(){v(e,"class","w-full max-w-4xl text-lg flex flex-col px-2")},m(a,n){c(a,e,n)},p:w,d(a){a&&l(e)}}}function S(m){let e,s,a='<div class="max-w-3xl p-3"><div class="hero w-full h-20 xs:h-36 sm:h-48 md:h-64 lg:h-80 flex justify-start svelte-c5nfw9"><h1 class="font-mono text-xs xs:text-xl sm:text-2xl md:text-4xl lg:text-5xl mt-9 ml-1 xs:mt-14 xs:ml-3 sm:mt-16 sm:ml-4 md:mt-20 md:ml-5 lg:mt-24">italian<br/>collegiate<br/>programming<br/>contest</h1></div></div>',n,i,r;return i=new k({props:{$$slots:{default:[A]},$$scope:{ctx:m}}}),{c(){e=h(),s=f("div"),s.innerHTML=a,n=h(),I(i.$$.fragment),this.h()},l(t){b("svelte-p45pw5",document.head).forEach(l),e=d(t),s=u(t,"DIV",{class:!0,"data-svelte-h":!0}),g(s)!=="svelte-u0esr3"&&(s.innerHTML=a),n=d(t),T(i.$$.fragment,t),this.h()},h(){document.title="ITACPC - Italian Collegiate Programming Contest",v(s,"class","w-full flex justify-center bg-base-200 border-b-[1.5px] border-base-300 shadow-sm z-10")},m(t,o){c(t,e,o),c(t,s,o),c(t,n,o),_(i,t,o),r=!0},p(t,[o]){const p={};o&1&&(p.$$scope={dirty:o,ctx:t}),i.$set(p)},i(t){r||(P(i.$$.fragment,t),r=!0)},o(t){$(i.$$.fragment,t),r=!1},d(t){t&&(l(e),l(s),l(n)),E(i,t)}}}class M extends C{constructor(e){super(),y(this,e,null,S,x,{})}}export{M as component};

import{s as x,a as h,e as f,h as b,d as r,c as d,b as u,i as g,j as v,k as c,n as C}from"../chunks/scheduler.piR_H7nd.js";import{S as w,i as y,c as I,a as _,m as T,t as P,b as $,d as W}from"../chunks/index.C44RW9Sf.js";import{b as k}from"../chunks/paths.7SVKq-Sn.js";import{C as E}from"../chunks/Content.CKxdvEWY.js";function R(p){let e,s=`<div class="card bg-green-100 shadow-xl mb-8"><div class="card-body"><h2 class="card-title svelte-c5nfw9"><span class="badge badge-lg bg-green-400">NEW</span>
				...
				best of the University</strong> and thus deserve to go to SWERC.</p></div>`;return{c(){e=f("div"),e.innerHTML=s,this.h()},l(a){e=u(a,"DIV",{class:!0,"data-svelte-h":!0}),g(e)!=="svelte-1starca"&&(e.innerHTML=s),this.h()},h(){v(e,"class","w-full max-w-4xl text-lg flex flex-col px-2")},m(a,n){c(a,e,n)},p:C,d(a){a&&r(e)}}}function S(p){let e,s,a='<div class="max-w-3xl p-3"><div class="hero w-full h-20 xs:h-36 sm:h-48 md:h-64 lg:h-80 flex justify-start svelte-c5nfw9"><h1 class="font-mono text-xs xs:text-xl sm:text-2xl md:text-4xl lg:text-5xl mt-9 ml-1 xs:mt-14 xs:ml-3 sm:mt-16 sm:ml-4 md:mt-20 md:ml-5 lg:mt-24">italian<br/>collegiate<br/>programming<br/>contest</h1></div></div>',n,i,l;return i=new E({props:{$$slots:{default:[R]},$$scope:{ctx:p}}}),{c(){e=h(),s=f("div"),s.innerHTML=a,n=h(),I(i.$$.fragment),this.h()},l(t){b("svelte-1anpopb",document.head).forEach(r),e=d(t),s=u(t,"DIV",{class:!0,"data-svelte-h":!0}),g(s)!=="svelte-u0esr3"&&(s.innerHTML=a),n=d(t),_(i.$$.fragment,t),this.h()},h(){document.title="Home",v(s,"class","w-full flex justify-center bg-base-200 border-b-[1.5px] border-base-300 shadow-sm z-10")},m(t,o){c(t,e,o),c(t,s,o),c(t,n,o),T(i,t,o),l=!0},p(t,[o]){const m={};o&1&&(m.$$scope={dirty:o,ctx:t}),i.$set(m)},i(t){l||(P(i.$$.fragment,t),l=!0)},o(t){$(i.$$.fragment,t),l=!1},d(t){t&&(r(e),r(s),r(n)),W(i,t)}}}class M extends w{constructor(e){super(),y(this,e,null,S,x,{})}}export{M as component};

...
<li>
	<details bind:open={dropdownOpened} use:clickOutside on:outsideclick={closeDropdown}>
		...
		<ul class="p-2">
			<li>
				<a
					href="{base}/competition/tasks/2025"
			...
			<li>
				<a
					href="{base}/competition/rules"
					class:font-bold={$page.route.id === `${base}/competition/rules`}
...
<li>
	<a
		...
		class:font-bold={$page.route.id === `${base}/universities`}
		on:click={closeDrawer}>Universities</a
	>
</li>
<li>
	<a
